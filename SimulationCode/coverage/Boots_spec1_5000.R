...
parameters <- expand.grid(1:500,c(1,3:8))[(process+1),]

spec = as.numeric(parameters[2])
cova_spec = 1
sample_size = 5000
delta_n <- c(0.2, 0.4, 0.2, 0.2, 0.2, 0.1, 0.4, 0.2)[as.numeric(parameters[2])]
scale <- c(1.0, 1.0, 1.0, 0.9, 0.6, 1.0, 1.0, 1.0)[as.numeric(parameters[2])]
...
saveRDS(ci_coverage,
     file=paste0("/n/home01/xwu1993/GPSmatching2/coverage/5000/coverage",sample_size,"gps_spec",spec,"cova_spec",cova_spec,"process",process, ".rds"))
