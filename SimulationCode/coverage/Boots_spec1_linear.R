...
cova_spec = 1
sample_size = 200
delta_n <- c(1.9, 1.9, 2.0, 1.9, 2.0, 1.4, 1.9, 1.9)[as.numeric(parameters[2])]
scale <- c(1.0, 1.0, 0.9, 1.0, 0.9, 0.8, 1.0, 1.0)[as.numeric(parameters[2])]
...
saveRDS(ci_coverage,
     file=paste0("/n/home01/xwu1993/GPSmatching2/coverage/200_linear_m2/coverage",sample_size,"gps_spec",spec,"cova_spec",cova_spec,"process",process, ".rds"))
