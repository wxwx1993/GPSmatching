...
#SBATCH -J 1000boots  #job name, this case:aw-area weighted aggregation
...
R CMD BATCH --quiet --no-restore --no-save Boots_spec1_1000_linear.R /n/home01/xwu1993/GPSmatching2/output/test_${SLURM_ARRAY_TASK_ID}.Rout
