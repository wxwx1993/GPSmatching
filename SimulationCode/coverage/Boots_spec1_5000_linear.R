...
cova_spec = 1
sample_size = 5000
delta_n <- c(0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4)[as.numeric(parameters[2])]
scale <- c(1.0, 1.0, 1.0, 0.7, 1.0, 0.8, 1.0, 1.0)[as.numeric(parameters[2])]
...
saveRDS(ci_coverage,
     file=paste0("/n/home01/xwu1993/GPSmatching2/coverage/5000_linear_m2/coverage",sample_size,"gps_spec",spec,"cova_spec",cova_spec,"process",process, ".rds"))
