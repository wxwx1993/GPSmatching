...
#SBATCH --mem=12000 #memory requested
#SBATCH -J gps200  #job name, this case:aw-area weighted aggregation
...
R CMD BATCH --quiet --no-restore --no-save Benchmark200.R /n/home01/xwu1993/GPSmatching/output/test_${SLURM_ARRAY_TASK_ID}.Rout
