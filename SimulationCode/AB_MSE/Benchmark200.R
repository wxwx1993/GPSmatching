...
save(a.vals,true.quad.response,dose_match.quad0.list,dose_match_SL.quad0.list,dose_cova.quad0.list,dose_IPTW.quad0.list,dose_DR.quad0.list,dose_IPTW_trim.quad0.list,dose_DR_trim.quad0.list,
