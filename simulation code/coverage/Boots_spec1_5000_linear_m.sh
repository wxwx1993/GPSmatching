...
#SBATCH --array=0-4999 #number of jobs to run, it is currently set to 1 job(1 year), change it to array=1-13 for 13 years(jobs)
#SBATCH --mem=20000 #memory requested
#SBATCH -J 5000m  #job name, this case:aw-area weighted aggregation
...
R CMD BATCH --quiet --no-restore --no-save Boots_spec1_5000_linear_m.R /n/home01/xwu1993/GPSmatching2/output/test_${SLURM_ARRAY_TASK_ID}.Rout
