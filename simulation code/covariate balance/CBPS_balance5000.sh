...
#SBATCH --array=7 #number of jobs to run, it is currently set to 1 job(1 year), change it to array=1-13 for 13 years(jobs)
#SBATCH --mem=3000 #memory requested
...
R CMD BATCH --quiet --no-restore --no-save CBPS_balance5000.R /n/home01/xwu1993/GPSmatching/output/balance5000_${SLURM_ARRAY_TASK_ID}.Rout
