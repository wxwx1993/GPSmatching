...
and labeled it as the generalized propensity score (GPS). In this package, we use 
a non-parametric model to estimate GPS values [@kennedy_2017]. The prediction 
models are developed using the SuperLearner Package [@superlearner_2007]. 
